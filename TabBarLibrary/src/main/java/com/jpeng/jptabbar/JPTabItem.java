...
public class JPTabItem extends BadgeRelativeLayout {
   ...
   public void setDismissDelegate(BadgeDismissListener listener) {
     ...
     * 设置TabItem选中的状态
     */
    public void setSelect(Animatable animater, boolean selected, boolean animated){
        setSelect(animater,selected,animated,true);
    }

    public void setSelect(Animatable animater,boolean selected,boolean animated,boolean filter){
