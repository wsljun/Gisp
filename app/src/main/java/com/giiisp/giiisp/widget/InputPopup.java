...
public class InputPopup extends BasePopupWindow implements View.OnClickListener {
    ...
    public InputPopup(Activity context,String title) {
        super(context);
    ...
    public View onCreatePopupView() {
        return LayoutInflater.from(getContext()).inflate(R.layout.input_dialog, null);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_Compelete:
                Utils.showToast(mInputEdittext.getText().toString());
                dismiss();
                break;
            default:
                break;
