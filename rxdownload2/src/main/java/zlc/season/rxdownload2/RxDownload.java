...
public class RxDownload {
    ...
    public List<DownloadRecord> getMissionIdDownloadRecords(Context context, String id) {
        return DataBaseHelper.getSingleton(context).readMissionsRecord(id);
    }

    public List<String> getMissionIdAll(Context context) {
        return DataBaseHelper.getSingleton(context).readMissionIdAll();
    }
