...
class Db {
    ...
    static final class RecordTable {
        ...
        static final String ALTER_TABLE_ADD_VERSION = "ALTER TABLE " + TABLE_NAME + " ADD " + COLUMN_VERSION + " TEXT";
        static final String ALTER_TABLE_ADD_TITLE = "ALTER TABLE " + TABLE_NAME + " ADD " + COLUMN_TITLE + " TEXT";
        static final String ALTER_TABLE_ADD_TIME = "ALTER TABLE " + TABLE_NAME + " ADD " + COLUMN_TIME + " TEXT";
        ...
        static ContentValues insert(DownloadBean bean, int flag, String missionId) {
            ...
            values.put(COLUMN_VERSION, bean.getVersion());
            values.put(COLUMN_TITLE, bean.getTitle());
            values.put(COLUMN_TIME, bean.getTime());
        ...
        static DownloadRecord read(Cursor cursor) {
            ...
            record.setVersion(cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_VERSION)));
        ...
        static String readMissionId(Cursor cursor){
           return cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_MISSION_ID));
        }
